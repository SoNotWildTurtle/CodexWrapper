...
if ($performedConfigUpdate -and -not $role -and -not $goal -and -not $showConfig -and -not $showConfigDiffRequested -and -not $ShowConfigList -and -not $showConfigWhichRequested -and -not $configExportRequested -and -not $configEnvRequested -and -not $showConfigTemplateRequested) {
    return
}
